...
import PredictionContract from "./contracts/Prediction.json";
  ...
  function InflationRate(props) {
    ...
    return (
      <div>
        <Button variant="contained" target="_blank" fullWidth key="three" disableElevation={true} disableFocusRipple={true} disableRipple={true} sx={{height:80,borderRadius: 2.5, "&.MuiButtonBase-root:hover": {bgcolor: '#000000', cursor: 'default'}}}>
          <Grid container>
            <Grid item container direction="column" xs={6} justifyContent='center'>
              <Typography variant="h8" color="secondary" gutterBottom>
                Inflation Rate
              </Typography>
            </Grid>
            <Grid item container direction="column" xs={6} justifyContent='center'>
  ...
  export default function LastPredictionButtons(props) {  
    return (
      <React.Fragment>
        <Box>
